...
const projects = [
    ...
    },
    {
        ...
        description: 'play the toughest dice game ever created with moertal combat II characters. roll dice to reach target score. rolled a double? all turn\'s points are lost and turn is over.',
        techs: ['<i class="fab fa-react fa-3x"></i>','<i class="fab fa-js-square fa-3x"></i>','<i class="fab fa-html5 fa-3x"></i>','<i class="fab fa-css3-alt fa-3x"></i>']
    },
    {
        title: 'Tesla Mockup',
